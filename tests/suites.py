...
SUITES: list = [
    ...
    {"path": "unit/test_placeholder_password.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_audit_webhook.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_printing.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_operator_api.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_video_declined.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_system_usage.py", "tier": "unit", "timeout": 120},
    ...
    {"path": "unit/test_appimage_l4t_xcb.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_appimage_relocation.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_docs_tables.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_session_launcher.py", "tier": "unit", "timeout": 120},
    ...
    {"path": "unit/test_output_layout_stage.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_display_geometry.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_display_stream_box.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_stream_density.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_slider_stops.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_dpi_default_mirror.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_dpi_verb_owner.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_ebc_locked.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_v4l2_staging_layout.py", "tier": "unit", "timeout": 300},
    {"path": "unit/test_session_density.py", "tier": "unit", "timeout": 120},
    ...
    {"path": "unit/test_release_assets.py", "tier": "unit", "timeout": 120},
    ...
    {"path": "unit/test_capture_demand.py", "tier": "unit", "timeout": 120},
    {"path": "unit/test_capture_demand_readers.py", "tier": "unit", "timeout": 120},
    ...
    {"path": "integration/test_clipboard_flavours.py", "tier": "integration", "timeout": 300},
    {"path": "integration/test_audit_webhook.py", "tier": "integration", "timeout": 600},
    {"path": "integration/test_print_queue.py", "tier": "integration", "timeout": 300},
    {"path": "integration/test_system_usage.py", "tier": "integration", "timeout": 120},
    {"path": "integration/test_clipboard_read_stall.py", "tier": "integration", "timeout": 300},
    {"path": "integration/test_audio_start_stall.py", "tier": "integration", "timeout": 300},
    ...
    {"path": "integration/test_dpi_startup_order.py", "tier": "integration", "timeout": 300,
     "selectors": ["websockets", "webrtc"]},
    {"path": "integration/test_lost_frame_verb.py", "tier": "integration", "timeout": 300},
    ...
    {"path": "integration/test_wayland_extension_shrink.py", "tier": "integration", "timeout": 300},
    {"path": "integration/test_frame_timing.py", "tier": "integration", "timeout": 300},
    ...
    {"path": "integration/test_output_layout.py", "tier": "integration", "timeout": 300},
    ...
    {"path": "integration/test_capture_demand.py", "tier": "integration", "timeout": 300},
    {"path": "integration/test_wire_header_picture_type.py", "tier": "integration", "timeout": 300},
    {"path": "integration/test_session_launcher.py", "tier": "integration", "timeout": 600},
    ...
    {"path": "e2e/test_dashboards.py", "tier": "e2e", "timeout": 1200,
     "selectors": ["classic", "wish", "gates", "hidpi", "hidpi-webrtc", "raw-motion",
                   "raw-motion-webrtc", "dpi-resolution", "second-screen"]},
    ...
    {"path": "e2e/test_clipboard_rich.py", "tier": "e2e", "timeout": 1200,
    ...
    {"path": "e2e/test_frame_ancestors.py", "tier": "e2e", "timeout": 300},
    ...
    {"path": "e2e/test_webcam.py", "tier": "e2e", "timeout": 900,
     "selectors": ["websockets", "webrtc", "ondemand", "av1", "webrtcpref", "locked", "nowebcodecs", "rotation", "reformat", "detail", "encoderpref", "fullcolor"]},
    ...
    {"path": "e2e/test_file_transfer.py", "tier": "e2e", "timeout": 1200,
     "selectors": ["websockets", "webrtc", "policy"]},
    {"path": "e2e/test_printing.py", "tier": "e2e", "timeout": 1200,
     "selectors": ["websockets", "webrtc", "policy"]},
    {"path": "e2e/test_operator_api.py", "tier": "e2e", "timeout": 1200,
     "selectors": ["websockets", "webrtc", "wayland"]},
    {"path": "e2e/test_encoder_support.py", "tier": "e2e", "timeout": 900,
     "selectors": ["menu", "pinned"]},
    {"path": "e2e/test_system_usage.py", "tier": "e2e", "timeout": 600,
     "selectors": ["websockets", "webrtc"]},
    ...
    {"path": "e2e/test_jupyter_proxy.py", "tier": "e2e", "timeout": 600},
