        ...
        {(renderableSettings.videoSettings ?? true) && (
          <div className="sidebar-section">
            ...
            {sectionsOpen.settings && (
                ...
                {!isWebrtc && showCRF && usePaintOverQuality && (renderableSettings.videoPaintoverCRF ?? true) && (
                  <div className="dev-setting-item">
                ...
                {!isWebrtc && showH264Options && usePaintOverQuality && (renderableSettings.videoPaintoverBurstFrames ?? true) && (
                  <div className="dev-setting-item">
