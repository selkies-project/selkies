...
const en = {
    ...
    buttons: {
        ...
        useCpuDisableTitle: "Disable Force CPU Encoding (Use nvenc/vaapi)",
        usePaintOverQualityEnableTitle: "Enable Paint-Overs (Cleans up static portions of the screen)",
        usePaintOverQualityDisableTitle: "Disable Paint-Overs (Static portions of the screen keep their streaming quality)",
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "Unsupported Browser",
        ...
        stats: {
            ...
            client: "client",
            server: "server",
            throttled: "The server is holding frames back because this client is falling behind",
        ...
        clipboard: {
            ...
            upLabel: "Send to session",
            upDetails: "Carry what you copy here into the remote session.",
            downLabel: "Receive from session",
        ...
        shortcuts: {
            title: "Shortcuts",
            enabledLabel: "Shortcuts active",
            enabledDetails: "Let these chords act here. Off, they reach the remote session instead.",
...
const es = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "Navegador no compatible",
        ...
        stats: {
            ...
            decoderLabel: "Decodificador",
            connectionLabel: "Conexión",
            hardware: "hardware",
            software: "software",
            client: "cliente",
            server: "servidor",
            throttled: "El servidor está reteniendo fotogramas porque este cliente se está quedando atrás",
            copyLabel: "Copiar estadísticas",
        },
        clipboard: {
            uploadImage: "Subir imagen",
             ...
             upLabel: "Enviar a la sesión",
             upDetails: "Lleva a la sesión remota lo que copias aquí.",
             downLabel: "Recibir de la sesión",
        ...
        shortcuts: {
            title: "Atajos",
            enabledLabel: "Atajos activos",
            enabledDetails: "Deja que estos atajos actúen aquí. Desactivado, llegan a la sesión remota.",
...
const zh_cn = {
    ...
    sections: {
        ...
        shortcuts: {
            title: "快捷键",
            enabledLabel: "快捷键生效",
            enabledDetails: "让这些组合键在此生效。关闭后，它们将传递给远程会话。",
            fullscreen: "切换全屏",
            openMenu: "打开或关闭仪表板",
...
const hi = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "असमर्थित ब्राउज़र",
        ...
        stats: {
            ...
            client: "क्लाइंट",
            server: "सर्वर",
            throttled: "यह क्लाइंट पिछड़ रहा है, इसलिए सर्वर फ़्रेम रोक रहा है",
            copyLabel: "आँकड़े कॉपी करें",
        },
        clipboard: {
            ...
            upLabel: "सत्र में भेजें",
            upDetails: "आप यहाँ जो कॉपी करते हैं उसे दूरस्थ सत्र में ले जाता है।",
            downLabel: "सत्र से प्राप्त करें",
        ...
        shortcuts: {
            title: "शॉर्टकट",
            enabledLabel: "शॉर्टकट सक्रिय",
            enabledDetails: "इन कुंजी संयोजनों को यहाँ काम करने दें। बंद होने पर वे दूरस्थ सत्र तक पहुँचते हैं।",
...
const pt = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "Navegador não suportado",
        ...
        stats: {
            ...
            client: "cliente",
            server: "servidor",
            throttled: "O servidor está retendo quadros porque este cliente está ficando para trás",
            copyLabel: "Copiar estatísticas",
        },
        clipboard: {
            ...
            upLabel: "Enviar para a sessão",
            upDetails: "Leva para a sessão remota o que você copia aqui.",
            downLabel: "Receber da sessão",
        ...
        shortcuts: {
            title: "Atalhos",
            enabledLabel: "Atalhos ativos",
            enabledDetails: "Deixa estes atalhos agirem aqui. Desligado, eles chegam à sessão remota.",
...
const fr = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "Navigateur non pris en charge",
        ...
        stats: {
            ...
            encoderLabel: "Encodeur",
            captureLabel: "Capture",
            decoderLabel: "Décodeur",
            connectionLabel: "Connexion",
            hardware: "matériel",
            software: "logiciel",
            client: "client",
            server: "serveur",
            throttled: "Le serveur retient des images car ce client prend du retard",
            copyLabel: "Copier les statistiques",
        },
        clipboard: {
            ...
            upLabel: "Envoyer vers la session",
            upDetails: "Transmet à la session distante ce que vous copiez ici.",
            downLabel: "Recevoir de la session",
        ...
        shortcuts: {
            title: "Raccourcis",
            enabledLabel: "Raccourcis actifs",
            enabledDetails: "Laisse ces raccourcis agir ici. Désactivé, ils atteignent la session distante.",
...
const ru = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "Браузер не поддерживается",
        ...
        stats: {
            ...
            encoderLabel: "Кодировщик",
            captureLabel: "Захват",
            decoderLabel: "Декодер",
            connectionLabel: "Соединение",
            hardware: "аппаратный",
            software: "программный",
            client: "клиент",
            server: "сервер",
            throttled: "Сервер придерживает кадры, потому что этот клиент не успевает",
            copyLabel: "Копировать статистику",
        },
        clipboard: {
            ...
            upLabel: "Отправлять в сессию",
            upDetails: "Переносит в удалённую сессию то, что вы копируете здесь.",
            downLabel: "Получать из сессии",
        ...
        shortcuts: {
            ...
            enabledLabel: "Сочетания клавиш активны",
            enabledDetails: "Позволяет этим сочетаниям работать здесь. При отключении они попадают в удалённую сессию.",
...
const de = {
    ...
    sections: {
        video: {
            ...
            encoderLabel: "Encoder:",
            webcamEncoderLabel: "Webcam-Encoder:",
            encoderUnsupported: "Browser nicht unterstützt",
        ...
        stats: {
            ...
            client: "Client",
            server: "Server",
            throttled: "Der Server hält Bilder zurück, weil dieser Client nicht mitkommt",
            copyLabel: "Statistiken kopieren",
        },
        clipboard: {
            ...
            upLabel: "An Sitzung senden",
            upDetails: "Überträgt in die entfernte Sitzung, was Sie hier kopieren.",
            downLabel: "Von Sitzung empfangen",
        ...
        shortcuts: {
            title: "Tastenkürzel",
            enabledLabel: "Tastenkürzel aktiv",
            enabledDetails: "Lässt diese Tastenkürzel hier wirken. Ausgeschaltet erreichen sie die entfernte Sitzung.",
...
const tr = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "Desteklenmeyen tarayıcı",
        ...
        stats: {
            ...
            client: "istemci",
            server: "sunucu",
            throttled: "Bu istemci geride kaldığı için sunucu kareleri bekletiyor",
            copyLabel: "İstatistikleri kopyala",
        },
        clipboard: {
            ...
            upLabel: "Oturuma gönder",
            upDetails: "Burada kopyaladığınızı uzak oturuma taşır.",
            downLabel: "Oturumdan al",
        ...
        shortcuts: {
            title: "Kısayollar",
            enabledLabel: "Kısayollar etkin",
            enabledDetails: "Bu kısayolların burada çalışmasına izin verir. Kapalıyken uzak oturuma ulaşırlar.",
...
const it = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "Browser non supportato",
        ...
        stats: {
            ...
            encoderLabel: "Codificatore",
            captureLabel: "Cattura",
            decoderLabel: "Decodificatore",
            connectionLabel: "Connessione",
            hardware: "hardware",
            software: "software",
            client: "client",
            server: "server",
            throttled: "Il server sta trattenendo i fotogrammi perché questo client è in ritardo",
            copyLabel: "Copia statistiche",
        },
        clipboard: {
            ...
            upLabel: "Invia alla sessione",
            upDetails: "Porta nella sessione remota ciò che copi qui.",
            downLabel: "Ricevi dalla sessione",
        ...
        shortcuts: {
            title: "Scorciatoie",
            enabledLabel: "Scorciatoie attive",
            enabledDetails: "Lascia agire qui queste scorciatoie. Disattivato, raggiungono la sessione remota.",
...
const nl = {
    ...
    sections: {
        video: {
            ...
            encoderLabel: "Encoder:",
            webcamEncoderLabel: "Webcam-encoder:",
            encoderUnsupported: "Browser niet ondersteund",
        ...
        stats: {
            ...
            client: "client",
            server: "server",
            throttled: "De server houdt frames tegen omdat deze client achterloopt",
            copyLabel: "Statistieken kopiëren",
        },
        clipboard: {
            ...
            upLabel: "Naar sessie sturen",
            upDetails: "Brengt wat u hier kopieert naar de externe sessie.",
            downLabel: "Van sessie ontvangen",
        ...
        shortcuts: {
            title: "Sneltoetsen",
            enabledLabel: "Sneltoetsen actief",
            enabledDetails: "Laat deze sneltoetsen hier werken. Uit bereiken ze de externe sessie.",
...
const ar = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "متصفح غير مدعوم",
        ...
        stats: {
            ...
            latencyLabel: "الكمون",
            encoderLabel: "المُرمِّز",
            captureLabel: "الالتقاط",
            decoderLabel: "مفكّك الترميز",
            connectionLabel: "الاتصال",
            hardware: "عتادي",
            software: "برمجي",
            client: "العميل",
            server: "الخادم",
            throttled: "يؤخّر الخادم الإطارات لأن هذا العميل متأخر",
            copyLabel: "نسخ الإحصاءات",
        },
        clipboard: {
            ...
            upLabel: "إرسال إلى الجلسة",
            upDetails: "ينقل ما تنسخه هنا إلى الجلسة البعيدة.",
            downLabel: "استقبال من الجلسة",
        ...
        shortcuts: {
            title: "الاختصارات",
            enabledLabel: "الاختصارات نشطة",
            enabledDetails: "يسمح لهذه الاختصارات بالعمل هنا. عند الإيقاف تصل إلى الجلسة البعيدة.",
...
const ko = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "지원되지 않는 브라우저",
        ...
        stats: {
            ...
            client: "클라이언트",
            server: "서버",
            throttled: "이 클라이언트가 뒤처지고 있어 서버가 프레임 전송을 늦추고 있습니다",
            copyLabel: "통계 복사",
        },
        clipboard: {
            uploadImage: "이미지 업로드",
            ...
            upLabel: "세션으로 보내기",
            upDetails: "여기서 복사한 내용을 원격 세션으로 옮깁니다.",
            downLabel: "세션에서 받기",
        ...
        shortcuts: {
            title: "단축키",
            enabledLabel: "단축키 사용",
            enabledDetails: "이 단축키가 여기서 동작하도록 합니다. 끄면 원격 세션으로 전달됩니다.",
            fullscreen: "전체 화면 전환",
...
const ja = {
    ...
    buttons: {
        ...
        useCpuDisableTitle: "強制 CPU エンコーディングを無効にする (nvenc/vaapi を使う)",
        usePaintOverQualityEnableTitle: "静止領域の補正を有効にする (画面の静的な部分をクリーンアップします)",
        usePaintOverQualityDisableTitle: "静止領域の補正を無効にする (画面の静的な部分をクリーンアップしません)",
    ...
    sections: {
        ...
        stats: {
            ...
            client: "クライアント",
            server: "サーバー",
            throttled: "このクライアントの処理が遅れているため、サーバーがフレームの送信を抑えています",
            copyLabel: "統計をコピー",
        },
        clipboard: {
            ...
            upLabel: "セッションへ送る",
            upDetails: "ここでコピーした内容をリモートセッションに渡します。",
            downLabel: "セッションから受け取る",
        ...
        shortcuts: {
            title: "ショートカット",
            enabledLabel: "ショートカット有効",
            enabledDetails: "これらのキー操作をここで動作させます。オフにするとリモートセッションに渡されます。",
...
const vi = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "Trình duyệt không hỗ trợ",
        ...
        stats: {
            ...
            latencyLabel: "Độ trễ",
            encoderLabel: "Bộ mã hóa",
            captureLabel: "Thu hình",
            decoderLabel: "Bộ giải mã",
            connectionLabel: "Kết nối",
            hardware: "phần cứng",
            software: "phần mềm",
            client: "máy khách",
            server: "máy chủ",
            throttled: "Máy chủ đang giữ lại khung hình vì máy khách này bị chậm",
            copyLabel: "Sao chép thống kê",
        },
        clipboard: {
            ...
            upLabel: "Gửi đến phiên",
            upDetails: "Đưa những gì bạn sao chép ở đây vào phiên từ xa.",
            downLabel: "Nhận từ phiên",
        ...
        shortcuts: {
            title: "Phím tắt",
            enabledLabel: "Phím tắt đang bật",
            enabledDetails: "Cho phép các phím tắt này hoạt động tại đây. Khi tắt, chúng đến phiên từ xa.",
...
const th = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "เบราว์เซอร์ไม่รองรับ",
        ...
        stats: {
            ...
            encoderLabel: "ตัวเข้ารหัส",
            captureLabel: "การจับภาพ",
            decoderLabel: "ตัวถอดรหัส",
            connectionLabel: "การเชื่อมต่อ",
            hardware: "ฮาร์ดแวร์",
            software: "ซอฟต์แวร์",
            client: "ไคลเอนต์",
            server: "เซิร์ฟเวอร์",
            throttled: "เซิร์ฟเวอร์กำลังชะลอการส่งเฟรมเพราะไคลเอนต์นี้ตามไม่ทัน",
            copyLabel: "คัดลอกสถิติ",
        },
        clipboard: {
            ...
            upLabel: "ส่งไปยังเซสชัน",
            upDetails: "นำสิ่งที่คุณคัดลอกที่นี่ไปยังเซสชันระยะไกล",
            downLabel: "รับจากเซสชัน",
        ...
        shortcuts: {
            title: "ทางลัด",
            enabledLabel: "ทางลัดทำงานอยู่",
            enabledDetails: "ให้ทางลัดเหล่านี้ทำงานที่นี่ เมื่อปิด ทางลัดจะไปถึงเซสชันระยะไกล",
...
const fil = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "Hindi suportadong browser",
        ...
        stats: {
            ...
            captureLabel: "Capture",
            decoderLabel: "Decoder",
            connectionLabel: "Koneksyon",
            hardware: "hardware",
            software: "software",
            client: "client",
            server: "server",
            throttled: "Pinipigil ng server ang mga frame dahil nahuhuli ang client na ito",
            copyLabel: "Kopyahin ang stats",
        },
        clipboard: {
            ...
            upLabel: "Ipadala sa session",
            upDetails: "Dinadala sa remote session ang kinokopya mo rito.",
            downLabel: "Tanggapin mula sa session",
        ...
        shortcuts: {
            title: "Mga shortcut",
            enabledLabel: "Aktibo ang mga shortcut",
            enabledDetails: "Hinahayaang gumana rito ang mga shortcut na ito. Kapag naka-off, umaabot sila sa remote session.",
...
const da = {
    ...
    sections: {
        video: {
            ...
            encoderLabel: "Encoder:",
            webcamEncoderLabel: "Webcam-encoder:",
            encoderUnsupported: "Browser understøttes ikke",
        ...
        stats: {
            ...
            encoderLabel: "Encoder",
            captureLabel: "Optagelse",
            decoderLabel: "Dekoder",
            connectionLabel: "Forbindelse",
            hardware: "hardware",
            software: "software",
            client: "klient",
            server: "server",
            throttled: "Serveren holder billeder tilbage, fordi denne klient er bagud",
            copyLabel: "Kopiér statistik",
        },
        clipboard: {
            ...
            upLabel: "Send til sessionen",
            upDetails: "Fører det, du kopierer her, til den eksterne session.",
            downLabel: "Modtag fra sessionen",
        ...
        shortcuts: {
            title: "Genveje",
            enabledLabel: "Genveje aktive",
            enabledDetails: "Lader disse genveje virke her. Slået fra når de den eksterne session.",
...
const zh_tw = {
    ...
    closeDashboardTitle: "關閉控制面板",
    fullscreenTitle: "切換全螢幕模式",
    ...
    streamingModeTitle: "串流模式",
    buttons: {
        videoStreamEnableTitle: "開啟影片串流",
        videoStreamDisableTitle: "關閉影片串流",
        audioStreamEnableTitle: "開啟音訊串流",
        audioStreamDisableTitle: "關閉音訊串流",
        microphoneEnableTitle: "開啟麥克風",
        microphoneDisableTitle: "關閉麥克風",
        webcamEnableTitle: "開啟視訊鏡頭",
        webcamDisableTitle: "關閉視訊鏡頭",
        gamepadEnableTitle: "開啟遊戲手把",
        gamepadDisableTitle: "關閉遊戲手把",
        virtualKeyboardButtonTitle: "螢幕小鍵盤",
        videoFullColorEnableTitle: "開啟全彩視訊",
        videoFullColorDisableTitle: "關閉全彩視訊",
        videoStreamingModeDisableTitle: "關閉 Turbo 串流模式",
        videoStreamingModeEnableTitle: "開啟 Turbo 串流模式",
        useCpuEnableTitle: "開啟強制使用 CPU 編碼 (不使用 nvenc/vaapi)",
        useCpuDisableTitle: "關閉強制使用 CPU 編碼 (使用 nvenc/vaapi)",
        usePaintOverQualityEnableTitle: "開啟覆蓋繪製 (清理畫面中的靜態區域)",
        usePaintOverQualityDisableTitle: "關閉覆蓋繪製 (不清理畫面中的靜態區域)",
        binaryClipboardEnableTitle: "開啟圖片剪貼簿",
        binaryClipboardDisableTitle: "關閉圖片剪貼簿",
    },
    sections: {
        video: {
            title: "視訊設定",
            encoderLabel: "編碼器:",
            webcamEncoderLabel: "視訊鏡頭編碼器:",
            encoderUnsupported: "不支援的瀏覽器",
            framerateLabel: "影格速率 ({framerate} FPS):",
            bitrateLabel: "位元速率 ({bitrate}):",
            bufferLabelImmediate: "視訊緩衝區大小 (0 (立即)):",
            bufferLabelFrames: "視訊緩衝區大小 ({videoBufferSize} 幀):",
            crfLabel: "視訊 CRF ({crf}):",
            fullColorLabel: "全彩 4:4:4",
            streamingModeDetails: "Turbo 模式會停用所有的 VNC 邏輯，並像傳統的影片編碼器一樣對所有畫面進行編碼。",
            streamingModeLabel: "Turbo",
            useCpuLabel: "CPU 編碼",
            jpegQualityLabel: "基礎畫質: {jpegQuality}",
            paintOverJpegQualityLabel: "覆蓋繪製畫質: {paintOverJpegQuality}",
            paintoverCrfLabel: "覆蓋繪製 CRF ({crf}):",
            paintoverBurstLabel: "覆蓋繪製爆裂影格 ({frames}):",
            usePaintOverQualityLabel: "使用覆蓋繪製",
            rateControlLabel: "位元率控制模式",
        },
        audio: {
            title: "音訊設定",
            bitrateLabel: "音訊位元率 ({bitrate} kbps):",
            inputLabel: "輸入 (麥克風):",
            outputLabel: "輸出 (揚聲器):",
            outputNotSupported: "選擇的裝置在此瀏覽器不支援。",
            deviceErrorDefault: "音訊裝置錯誤: {errorName}",
            deviceErrorPermission: "權限被拒絕。請在瀏覽器設定中允許麥克風存取權限。",
            deviceErrorNotFound: "找不到音效裝置。",
            defaultInputLabelFallback: "輸入裝置 {index}",
            defaultOutputLabelFallback: "輸出裝置 {index}",
        },
        screen: {
            title: "顯示設定",
            presetLabel: "預設:",
            resolutionPresetSelect: "-- 選擇預設 --",
            widthLabel: "寬度:",
            heightLabel: "高度:",
            widthPlaceholder: "例如 1920",
            heightPlaceholder: "例如 1080",
            setManualButton: "設定自訂解析度",
            resetButton: "重置為視窗",
            scaleLocallyLabel: "本機縮放:",
            scaleLocallyOn: "開",
            scaleLocallyOff: "關",
            scaleLocallyTitleEnable: "開啟本機縮放 (保持比例縮放)",
            scaleLocallyTitleDisable: "關閉本機縮放 (使用精確解析度)",
            uiScalingLabel: "介面縮放",
            hidpiLabel: "HiDPI (完美像素)",
            hidpiEnableTitle: "開啟 HiDPI (完美像素)",
            hidpiDisableTitle: "關閉 HiDPI (使用 CSS 縮放)",
            hidpiDisabledNoResizeTitle: "伺服器已停用解析度變更功能（enable_resize）",
            hidpiDisabledManualTitle: "自訂解析度會以完全精確的像素進行串流；介面縮放則會調整其桌面大小",
            antiAliasingLabel: "反鋸齒",
            antiAliasingEnableTitle: "開啟反鋸齒 (平滑縮放)",
            antiAliasingDisableTitle: "關閉反鋸齒 (強制像素化渲染)",
            useNativeCursorStylesLabel: "使用 CSS 游標",
            useNativeCursorStylesEnableTitle: "使用 CSS 效果游標 (替換系統游標)",
            useNativeCursorStylesDisableTitle: "使用 Canvas 渲染游標（繪製到 Canvas）",
            rawPointerMotionLabel: "原始游標移動",
            rawPointerMotionEnableTitle: "在游標鎖定下向瀏覽器請求進行非加速移動（Windows 和 macOS 上允許，Linux 和 Android 上被拒絕）。",
            macCmdAsCtrlLabel: "Command 鍵（⌘）映射為 Ctrl 鍵",
            macCmdAsCtrlDisableTitle: "將 Command 鍵（⌘）作為 Super 鍵傳送，視窗管理器可能會綁定。",
            macCmdAsCtrlEnableTitle: "將 Command 鍵（⌘）作為 Control 鍵組合，從而實現遠端執行 Cmd+C 複製操作。",
            rawPointerMotionDisableTitle: "在游標鎖定狀態下保持此裝置的游標加速",
            addScreenTitle: "新增第二顯示器",
            addScreenButton: "新增顯示器 +",
            forceAlignedResolutionLabel: "強制對齊解析度",
            forceAlignedResolutionDetails: "強制將顯示解析度設為 16 像素的倍數",
            forceAlignedResolutionEnableTitle: "開啟強制對齊解析度",
            forceAlignedResolutionDisableTitle: "關閉強制對齊解析度",
        },
        stats: {
            title: "統計數據",
            cpuLabel: "CPU",
            ...
            client: "用戶端",
            server: "伺服器",
            throttled: "由於該用戶端的處理速度滯後，伺服器正在暫緩發送畫面。",
            copyLabel: "複製統計數據",
        },
        clipboard: {
            uploadImage: "上傳圖片",
            title: "剪貼簿",
            label: "伺服器剪貼簿:",
            placeholder: "從伺服器取得的剪貼簿內容...",
            binaryModeLabel: "圖片支援",
            binaryModeDetails: "允許在遠端與本機之間複製和貼上影像。",
            upLabel: "發送到遠端連線",
            upDetails: "將你在本地電腦複製的內容貼上到遠端連線。",
            downLabel: "從遠端連線接收",
        ...
        files: {
            title: "檔案",
            uploadButton: "上傳檔案",
            uploadButtonTitle: "上傳檔案到遠端連線",
            downloadButtonTitle: "下載檔案",
        },
        printing: {
            title: "列印",
            automaticLabel: "自動列印",
            automaticDetails: "每次列印檔案，自動開啟瀏覽器的列印對話視窗",
            printButton: "列印",
            saveButton: "儲存",
            openButton: "打開",
        },
        gamepads: {
            title: "遊戲手把",
            noActivity: "未偵測到實體遊戲手把的輸入...",
            touchEnableTitle: "開啟虛擬觸控遊戲手把",
            touchDisableTitle: "關閉虛擬觸控遊戲手把",
            touchActiveLabel: "虛擬觸控手把: 開",
            touchInactiveLabel: "虛擬觸控手把: 關",
            physicalHiddenForTouch: "當虛擬觸控手把啟用時，隱藏實體手把的畫面顯示。",
            noActivityMobileOrEnableTouch: "未偵測到實體遊戲手把。請啟用虛擬觸控手把或連接控制器。",
            gamepadTitle: "遊戲手把 {index}",
            loadingGamepad: "遊戲手把讀取中 {index}..."
        },
        apps: { 
          title: "應用程式",
          openButtonTitle: "應用程式管理",
          openButton: "應用程式管理"
        },
        shortcuts: {
            title: "快捷鍵",
            enabledLabel: "啟用快捷鍵",
            enabledDetails: "讓這些組合鍵在本地端生效。關閉此設定時，則會傳送到遠端連線中。",
            fullscreen: "切換到全螢幕",
            openMenu: "開啟或關閉控制面板",
            toggleGamepad: "開啟或關閉虛擬觸控手把",
            gamingMode: "切換到遊戲模式",
            pointerLock: "將游標鎖定在遠端連線",
            citeNotice: "引用我們的論文",
        },
        sharing: {
            title: "共享",
            viewerLabel: "觀眾",
            viewerTooltip: "僅能觀看（無法操作），可讓多個用戶端連線至此端點，並觀看即時串流",
            controllerLabel: "控制器 {n}",
            controllerTooltip: "玩家 {n} 號的遊戲手把輸入，此連接埠對於玩家 {n} 號能完全控制遊戲手把",
            openLinkTitle: "在新分頁中開啟 {label} 連結",
            copyLinkTitle: "複製 {label} 連結",
        }
    },
    resolutionPresets: {
        "1920x1080": "1920 x 1080 (FHD)",
        "1280x720": "1280 x 720 (HD)",
        "1366x768": "1366 x 768 (筆電)",
        "1920x1200": "1920 x 1200 (16:10)",
        "2560x1440": "2560 x 1440 (QHD)",
        "3840x2160": "3840 x 2160 (4K UHD)",
        "1024x768": "1024 x 768 (XGA 4:3)",
    ...
    appsModal: {
        launchButton: "啟動",
        closeAlt: "關閉應用程式的彈出式提示框",
        loading: "正在載入應用程式...",
        errorLoading: "無法載入應用程式資料。請再試一次。",
        retryButton: "重試",
        searchPlaceholder: "搜尋應用程式...",
        noAppsFound: "沒有找到任何相關軟體。",
        backButton: "回到列表",
        installButton: "安裝",
        updateButton: "更新",
        removeButton: "刪除",
        installedBadge: "已安裝",
        commandsDisabled: "無法安裝應用程式：此伺服器已停用遠端指令（SELKIES_COMMAND_ENABLED）。",
    },
    notifications: {
        warningPrefix: "警告",
        closeButtonAlt: "關閉 {fileName} 的通知",
        uploading: "上傳中... {progress}%",
        uploadComplete: "上傳完成",
        uploadFailed: "上傳失敗",
        errorPrefix: "錯誤:",
        unknownError: "發生未知的錯誤。",
        copiedTitle: "已複製: {label}",
        copiedMessage: "連結已複製到剪貼簿: {textToCopy}",
        copyFailedTitle: "複製失敗: {label}",
        copyFailedError: "無法將連結複製到剪貼簿。",
        scalingTitle: "縮放已更新：需要採取行動",
        scalingMessage: "已套用新的縮放設定。某些應用程式或桌面環境可能需要重新啟動。",
        clipboardImageRejected: "\"{name}\" 不是影像檔案格式（{mime}）",
        clipboardSkipReadonly: "觀眾不能設定剪貼簿",
        clipboardSkipNoImage: "請先選擇要上傳的圖片",
        commandFailed: "遠端指令執行失敗：{detail}",
        keyboardLockUnavailable: "此瀏覽器不支援鍵盤鎖定，按 Esc 鍵會退出遊戲模式，而不是回到工作階段。",
        keyboardLockBlockedByShields: "Brave 瀏覽器的防護（Shields）功能封鎖了鍵盤鎖定，導致按一下 Escape 鍵就會退出遊戲模式。需要在 Brave 防護（Shields）的「指紋追蹤保護」設定中允許該網站使用鍵盤 API，以便改為「長按 Escape 鍵」。",
        clipboardSkipBinaryDisabled: "伺服器端已停用圖片剪貼簿功能",
        clipboardSkipSendFailed: "無法傳送剪貼簿中的圖片",
        clipboardSkipInDisabled: "已停用傳送到遠端剪貼簿功能",
        clipboardSkipNotConnected: "未連線至遠端工作階段",
        clipboardSkipUnchanged: "剪貼簿已經是最新狀態",
        clipboardSkipDisabled: "伺服器端已停用剪貼簿功能",
        clipboardImageWriteFailed: "無法將圖片複製到您的剪貼簿：{detail}",
    },
    alerts: {
