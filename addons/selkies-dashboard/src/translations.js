...
const en = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "not supported by this browser",
...
const es = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "no compatible con este navegador",
...
const hi = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "इस ब्राउज़र में समर्थित नहीं",
...
const pt = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "não suportado por este navegador",
...
const fr = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "non pris en charge par ce navigateur",
...
const ru = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "не поддерживается этим браузером",
...
const de = {
    ...
    sections: {
        video: {
            ...
            encoderLabel: "Encoder:",
            webcamEncoderLabel: "Webcam-Encoder:",
            encoderUnsupported: "von diesem Browser nicht unterstützt",
...
const tr = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "bu tarayıcı tarafından desteklenmiyor",
...
const it = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "non supportato da questo browser",
...
const nl = {
    ...
    sections: {
        video: {
            ...
            encoderLabel: "Encoder:",
            webcamEncoderLabel: "Webcam-encoder:",
            encoderUnsupported: "niet ondersteund door deze browser",
...
const ar = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "غير مدعوم في هذا المتصفح",
...
const ko = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "이 브라우저에서 지원되지 않음",
...
const ja = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "このブラウザーでは非対応",
...
const vi = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "trình duyệt này không hỗ trợ",
...
const th = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "เบราว์เซอร์นี้ไม่รองรับ",
...
const fil = {
    ...
    sections: {
        video: {
            ...
            encoderUnsupported: "hindi suportado ng browser na ito",
...
const da = {
    ...
    sections: {
        video: {
            ...
            encoderLabel: "Encoder:",
            webcamEncoderLabel: "Webcam-encoder:",
            encoderUnsupported: "ikke understøttet af denne browser",
