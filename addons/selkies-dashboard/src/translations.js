...
const en = {
    ...
    buttons: {
        ...
        usePaintOverQualityDisableTitle: "Disable Paint-Overs (Not Cleans up static portions of the screen)",
...
const zh_tw = {
    ...
    buttons: {
        ...
        gamepadEnableTitle: "開啟遊戲手制",
        gamepadDisableTitle: "關閉遊戲手制",
        virtualKeyboardButtonTitle: "螢幕小鍵盤",
        videoFullColorEnableTitle: "開啟 全彩視訊",
        videoFullColorDisableTitle: "關閉 全彩視訊",
        videoStreamingModeDisableTitle: "開啟 Turbo串流模式",
        videoStreamingModeEnableTitle: "關閉 Turbo串流模式",
        ...
        binaryClipboardEnableTitle: "開啟剪貼簿",
        binaryClipboardDisableTitle: "關閉剪貼簿",
    },
    sections: {
        video: {
            title: "視訊設定",
            ...
            bufferLabelFrames: "視訊緩衝區大小 ({videoBufferSize} 帧):",
            crfLabel: "視訊 CRF ({crf}):",
            fullColorLabel: "全彩 4:4:4",
        ...
        screen: {
            ...
            useNativeCursorStylesLabel: "使用 CSS 遊標",
            useNativeCursorStylesEnableTitle: "使用 CSS 效果遊標 (替換系統游標)",
            useNativeCursorStylesDisableTitle: "使用 Canvas 渲染遊標（繪製到 Canvas）",
            rawPointerMotionLabel: "原始遊標移動",
            rawPointerMotionEnableTitle: "在遊標鎖定下向瀏覽器請求進行非加速移動（ Windows 和 macOS 上允許，Linux 和 Android 上被拒絕 ）。",
            macCmdAsCtrlLabel: "Command 鍵（⌘）映射為Ctrl 鍵",
            ...
            rawPointerMotionDisableTitle: "在遊標鎖定狀態下保持此裝置的遊標加速",
        ...
        gamepads: {
            title: "遊戲手制",
            noActivity: "未偵測到實體遊戲手制的輸入...",
            touchEnableTitle: "開啟虛擬觸控遊戲手制",
            touchDisableTitle: "關閉虛擬觸控遊戲手制",
            touchActiveLabel: "虛擬觸控手制: 開",
            touchInactiveLabel: "虛擬觸控手制: 關",
            physicalHiddenForTouch: "當虛擬觸控手制啟用時，隱藏實體手制的畫面顯示。",
            noActivityMobileOrEnableTouch: "未偵測到實體遊戲手制。請啟用虛擬觸控手制或連接控制器。",
            gamepadTitle: "遊戲手制 {index}",
            loadingGamepad: "遊戲手制讀取中 {index}..."
        },
        apps: { 
          title: "應用程式",
        ...
        shortcuts: {
            ...
            fullscreen: "切換到全螢幕",
            openMenu: "開啟或關閉控制面板",
            toggleGamepad: "開啟或關閉虛擬觸控手制",
            gamingMode: "切換到遊戲模式",
            pointerLock: "將遊標鎖定在遠端連線",
            citeNotice: "引用我們的論文",
        },
        sharing: {
            title: "共享",
            viewerLabel: "觀眾",
            viewerTooltip: "僅能觀看(沒法操作)，可讓多個用戶端連線至此端點，並觀看即時串流",
            controllerLabel: "控制器 {n}",
            controllerTooltip: "玩家 {n} 號的遊戲手制輸入，此連接埠對於玩家 {n} 號能完全控制遊戲手制",
