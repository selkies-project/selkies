...
// The remap DB (generated by gendb.js) keeps one mapping per platform for the
// same pad: raw button/axis indices differ across them, so the lookup is scoped
// to the platform this browser runs on. Anything not matched (ChromeOS, the
// BSDs) uses the evdev layout Linux browsers report.
const JSDB_PLATFORM = (() => {
...
export class GamepadManager {
    ...
    destroy() {
        ...
        // Clear the per-pad state on final destruction.
        this.state = {};
