...
const rateControlOptions = ["crf", "cbr"];
            ...
            <Tabs defaultValue={showVideoTab ? "video" : showAudioTab ? "audio" : "resolution"} className="w-full">
                ...
                <TabsContent value="video">
                    <CardContent className="space-y-4">
                        ...
                        {/* Striping, paint-over and 4:4:4 are websockets-pipeline features. */}
                        {!isWebrtc && isH264 && (
                            <>
                        ...
                        {!isWebrtc && (isH264 || activeEncoder === 'jpeg') && (renderableSettings.usePaintOverQuality ?? true) && (
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                        ...
                        {!isWebrtc && isH264 && usePaintOverQuality && (
                            <>
                        ...
                        {!isWebrtc && ['h264enc', 'h264enc-striped', 'jpeg'].includes(activeEncoder) && (renderableSettings.useCpu ?? true) && (
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
