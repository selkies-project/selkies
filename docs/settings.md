...
| `--congestion-control`<br>`SELKIES_CONGESTION_CONTROL` | `false`<br>bool | Adapt the video bitrate to the transport-wide-cc (GCC-style) bandwidth estimate from WebRTC receiver feedback. Effective in CBR rate-control mode; may trade quality/stability for congestion responsiveness. |
