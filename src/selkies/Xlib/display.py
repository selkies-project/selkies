    ...
    def __init__(self, display = None):
        ...
        for extname, modname in ext.__extensions__:
            if extname in exts:
                ...
                # Import the module and fetch it (relative to this vendored package
                # so the bundled extension is used, never an external python-xlib).
                importlib.import_module('.' + modname, ext.__name__)
