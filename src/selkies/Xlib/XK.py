...
def load_keysym_group(group):
    ...
    #Import just the keysyms module, relative to this vendored package so the
    #bundled keysym group is used, never an external python-xlib.
    mod = importlib.import_module('.keysymdef.' + group, __package__)
